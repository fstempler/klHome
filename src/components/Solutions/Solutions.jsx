...
const Solutions = () => {
    return (
        ...
        <div className='solutions__MainContainer container' id='Solutions'>
            ...
            <div className='solutions__Card-Container row container'>
                <div className='row solutions__Card-Container1'>                    
                <div className="card border-0 solutions__Card-Style solutions__Card-Pink" style={{width: '16rem', maxWidth: '18rem'}}>
                ...
                <div className="card border-0 solutions__Card-Style solutions__Card-Blue" style={{width: '16rem', maxWidth: '18rem'}}>
                ...
                <div className="card border-0 solutions__Card-Style solutions__Card-Orange" style={{width: '16rem', maxWidth: '18rem'}}>
                ...
                <div className="card border-0 solutions__Card-Style solutions__Card-Green" style={{width: '16rem', maxWidth: '18rem'}}>
                ...
                {/* INSERT ANOTHER ROW */}
                <div className='row solutions__Card-Container2'>
                <div className="card border-0 solutions__Card-Style solutions__Card-Green" style={{width: '16rem', maxWidth: '18rem'}}>
